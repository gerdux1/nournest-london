...
export const metadata: Metadata = {
  title: "Apartments",
  description:
    "Browse all NourNest serviced apartments in Canary Wharf, Kensington, and the City of London. Fully equipped, all bills included, flexible stays.",
};
          ...
          {LISTINGS.map((l) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <h2 className="mt-2 font-serif text-2xl text-[#385B4F] group-hover:underline underline-offset-4">
                  {l.title}
                </h2>
                <p className="mt-2 text-sm text-[#555555]">{l.shortDescription}</p>
                <div className="mt-4 flex justify-between text-sm text-[#555555]">
                  <span>
